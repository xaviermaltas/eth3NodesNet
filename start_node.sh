...
geth --datadir $NODE_NAME/ --syncmode 'full' --port $NODE_PORT --rpc --rpcaddr $NODE_IP --rpcport $NODE_RPC_PORT --rpcapi 'personal,db,eth,net,web3,txpool,miner' --bootnodes 'enode://6fee50f602ea84263b77d2730908adbb34e75d646d3ef9f5cec015693c31f0a0b22295c36e0fd892c6033d9f01c9697277fd96828fdfaff8f181c62bb8438971@127.0.0.1:30310' --networkid $NET_ID --gasprice '1' --unlock $NODE_ACCOUNT --password $NODE_NAME/password.txt --allow-insecure-unlock --verbosity 9 --mine